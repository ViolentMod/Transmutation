...
//Thanks to @Pahimar's EE3 Source Code :)
...
public class NBTHelper
{
    ...
    {
        if (NBTHelper.hasTag(itemStack, Names.NBT.TRANSMUTATION_TABLE_GUI_OPEN))
        {
            NBTHelper.removeTag(itemStack, Names.NBT.TRANSMUTATION_TABLE_GUI_OPEN);
        }
    }
