...
public class BlockTransmutation extends Block
{
    ...
    {
        if (world.getTileEntity(x, y, z) instanceof TileEntityTransmutation)
        {
            int direction = 0;
            ...
            {
                ((TileEntityTransmutation) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
            }

            ((TileEntityTransmutation) world.getTileEntity(x, y, z)).setOrientation(direction);
        }
    }
