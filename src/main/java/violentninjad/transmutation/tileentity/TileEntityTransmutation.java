...
import violentninjad.transmutation.net.MessageTileEntityTransmutation;
import violentninjad.transmutation.net.PacketHandler;
import violentninjad.transmutation.reference.Names;

public class TileEntityTransmutation extends TileEntity
{
    ...
    public TileEntityTransmutation()
    {
    ...
    {
        return PacketHandler.INSTANCE.getPacketFrom(new MessageTileEntityTransmutation(this));
    }
}
